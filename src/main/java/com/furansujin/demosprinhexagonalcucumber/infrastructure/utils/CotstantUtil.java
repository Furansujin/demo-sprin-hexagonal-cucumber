package com.furansujin.demosprinhexagonalcucumber.infrastructure.utils;
...
public class CotstantUtil {
    ...
    public static final String PROVIDER_FAMILY_NAME = "family_name";
    public static final String PROVIDER_GIVEN_NAME = "given_name";
